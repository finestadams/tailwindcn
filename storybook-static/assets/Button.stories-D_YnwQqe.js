...
}`,...(Gr=(Mr=M.parameters)==null?void 0:Mr.docs)==null?void 0:Gr.source}}};const Kr=["Primary","Alternative","Ghost","Outline","Danger","Link","Dark","GradientMonochrome","GradientDuotone","ColorShadow","Pill","FullWidth","IconOnly","Small","Medium","Large"],$r=Object.freeze(Object.defineProperty({__proto__:null,Alternative:h,ColorShadow:x,Danger:B,Dark:b,FullWidth:D,Ghost:y,GradientDuotone:k,GradientMonochrome:S,IconOnly:O,Large:M,Link:z,Medium:P,Outline:f,Pill:w,Primary:v,Small:C,__namedExportsOrder:Kr,default:Hr},Symbol.toStringTag,{value:"Module"}));export{$r as B,B as D,D as F,O as I,M as L,P as M,f as O,v as P,C as S,Tr as a,w as b};
